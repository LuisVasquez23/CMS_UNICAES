...
const Home = () => {
  ...
  return (
    <>
      ...
      <p class="text-center fw-light">Te presentamos un resumen de tu actividad en nuestro sitio web</p>
                ...
                <div className="card text-dark  mb-3">
                    ...
                    {pageCountNumber > 0 ? (
                      ...
                      <p className="fw-semibold mt-3 mb-3">No tienes páginas creadas.</p>
                        ...
                        <Link to="/dashboard/paginas/create" className="btn btn-success mt-2">
